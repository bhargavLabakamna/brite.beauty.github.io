<?php
    ...
    include('../script/modal/contact_addedit.php');
?>
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Contact Enquiry</h1>
            </div>
        </div>
        <div class="panel-heading">
    <button class="btn btn-primary pull-right contact_form_addedit" data-toggle="modal" data-target="#exampleModalCenter">New Button</button>
</div>
